...
-- Algunos clientes son morosos. Alg�n moroso no es cliente
-- Clientes que trabajan en cierto puesto. Clientes que compran con
-- Tarjetas
---------------------------------------------------------------------

/*
       --- Caracter�sticas detalladas de BDejemplo:                                                                             
- Hay morosos, que pueden ser clientes o no, con la misma informaci�n que los clientes.
  No relacionar con el resto.
- Un cliente trabaja como m�ximo en un puesto, estar en paro tambi�n se incluye, 
  con T�tulo = 'parado'.
...
- Una tarjeta tiene un tipo, un n�mero diferente en todas las tarjetas y la organizaci�n
  propietaria del tipo.
- El cliente puede tener varias tarjetas o ninguna. Como m�ximo tiene tres tarjetas. 
  Puede haber m�s de un propietario de cada tarjeta. Cada propietario tiene para cada
...
--  Nombre de Empresa, Precio de Acci�n (cotizaci�n), Cantidad de Capital
...
--    DNI del cliente, Nombre del Cliente, su Tel�fono
...
create table Cliente  
  ...
  --                 -- Raz�n para dejar esta redundancia
  PRIMARY KEY (DNI) 
);
...
--    DNI del cliente moroso, Nombre del Cliente, su Tel�fono
...
--  N�mero de Tarjeta, Tipo de Tarjeta, Organizaci�n de esa Tarjeta
...
-- la fecha de compra en entero, Tienda donde se compr�, Importe de compra
...
-- DNI del cliente, T�tulo del puesto de trabajo, sueldo en ese puesto
...
-- Tarjetas que tiene el cliente: su DNI, N�m Tarjeta
